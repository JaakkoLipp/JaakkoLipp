### Hi, I'm Jaakko
---
Software engineer and AI specialist based in Finland. I work on AI systems development, design, and governance, with a particular focus on enterprise infrastructure, data sovereignty, and the practical side of running open-weight LLMs in production.
...
Document enough that the setup can be rebuilt later.

#### Connect
---
- Portfolio: [jaalip.com](https://jaalip.com)
- GitHub: [@jaakko-lipponen](https://github.com/jaakko-lipponen)
- LinkedIn: [Jaakko Lipponen](https://www.linkedin.com/)
